...
var Application, Compiler, Generator, app, live, directory, fs, jade, match, path, promptly, sty;
...
Application = (function() {
  ...
  function Application() {
    ...
    this.program.command('new').alias('n').description('Setup the live-alloy directory structure.').action(this.setup);
    this.program.command('generate [type] [name]').alias('g').description('Generate a new (live-)alloy type such as a controller.').action(this.generate);
...
Compiler = (function() {
  ...
  Compiler.prototype.widgets = function() {
    ...
    for (_i = 0, _len = widgets.length; _i < _len; _i++) {
      ...
      _results.push(this.process("widgets/" + widget + "/controllers/", "ls", "js"));
    }
    return _results;
  };
  ...
  Compiler.prototype.build = {
    ...
    js: function(data) {
      return live.compile(data.toString(), {
        bare: true
      });
    },
    json: function(data) {
...
Generator = (function() {
  ...
  not_yet_implemented = function() {
    console.info("This generator hasn't been built into live-alloy yet. Please help us out by building it in:");
    return console.info("https://github.com/vastness/live-alloy");
  };
